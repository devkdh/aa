...
public class BikeVo {
	...
	public BikeVo(String addr_gu, int content_id, String content_nm, String new_addr, int cradle_count,
	...
	public String toString() {
		return "BikeVo [addr_gu=" + addr_gu + ", content_id=" + content_id + ", content_nm=" + content_nm
